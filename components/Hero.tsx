...
const Hero = () => {
  return (
    <section className="min-h-[80dvh] relative w-full flex flex-col justify-center items-start">
        ...
        <div className="relative flex flex-col items-center justify-between gap-6 z-10 w-4/5 mx-auto">
            <div className="rounded p-2 flex items-center gap-3 bg-white/20 backdrop-blur-sm border border-white/30 text-white text-xs font-bold uppercase tracking-wider">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between bg-white px-2 py-2 rounded w-full lg:w-1/2">
